...
import { YearlyTubeMapVisualisation } from "./YearlyTubeMapVisualisation";
import { NumbatDays } from "@/data/tube/numbat/types";
import { parseLinkLoadData } from "@/data/tube/numbat/parse";

export async function YearlyTubeMap({
  numbatData,
}: {
  ...
  for (const [year, days] of numbatData) {
